package dev.liquidnetwork.liquidpractice.statistics.menu;

import com.google.common.collect.Lists;
import dev.liquidnetwork.liquidpractice.LiquidPracticeCache;
import dev.liquidnetwork.liquidpractice.profile.Profile;
import dev.liquidnetwork.liquidpractice.util.SkullCreator;
    ...
    private static class KitLeaderboardsButton extends Button
    {
        ...
        public ItemStack getButtonItem(final Player player) {
            ...
            for (final KitLeaderboards kitLeaderboards : this.kit.getRankedEloLeaderboards()) {
                Profile profile = Profile.getByUuid(LiquidPracticeCache.getUUID(kitLeaderboards.getName()));
