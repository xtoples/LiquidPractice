package dev.liquidnetwork.liquidpractice.arena.selection;
...
public class  Selection {
	...
	public static Selection createOrGetSelection(Player player) {
		...
		player.setMetadata(SELECTION_METADATA_KEY, new FixedMetadataValue(LiquidPractice.getInstance(), selection));
