...
import dev.liquidnetwork.liquidpractice.util.chat.ChatHelper;
...
public class Party extends Team {
    ...
    public static void preload() {
        ...
        }.runTaskTimerAsynchronously(LiquidPractice.getInstance(), 100L, 100L);
        new BukkitRunnable() {
            public void run() {
        ...
        }.runTaskTimerAsynchronously(LiquidPractice.getInstance(), 1200L, 1200L);
    }
