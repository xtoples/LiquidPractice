package dev.liquidnetwork.liquidpractice.util.external.menu.menus;
...
import dev.liquidnetwork.liquidpractice.util.external.callback.TypeCallback;
import dev.liquidnetwork.liquidpractice.util.external.menu.button.ConfirmationButton;
