...
public class HCFMatch extends Match {
    ...
    @Override
    public void onStart() {
        getPlayers().forEach(player1 -> LiquidPractice.getInstance().getKnockbackManager().getKnockbackType().appleKitKnockback(player1, Kit.getByName("NoDebuff")));
    ...
    public boolean onEnd() {
        ...
        }.runTaskLater(LiquidPractice.getInstance(), 40L);
