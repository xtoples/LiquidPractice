...
public class SpectateCommand {
    ...
    public void execute(Player player, Player target) {
        ...
        if (!targetProfile.getSettings().isAllowSpectators() && !player.hasPermission("liquidpractice.staff")) {
            ...
            if (!targetProfile.getMatch().isFreeForAllMatch()) {
                for ( TeamPlayer teamPlayer : targetProfile.getMatch().getTeamPlayers() ) {
                    ...
                    if (inMatchPlayer != null) {
                        ...
                        if (!inMatchProfile.getSettings().isAllowSpectators() && !player.hasPermission("liquidpractice.staff")) {
