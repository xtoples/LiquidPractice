...
import dev.liquidnetwork.liquidpractice.event.types.sumo.command.SumoHostCommand;
import dev.liquidnetwork.liquidpractice.event.types.wizard.command.WizardHostCommand;
...
import dev.liquidnetwork.liquidpractice.event.types.brackets.command.BracketsHostCommand;
import dev.liquidnetwork.liquidpractice.event.types.lms.command.LMSHostCommand;
    ...
    private static class SelectEventButton extends Button {
        ...
        public void clicked(Player player, ClickType clickType) {
            ...
            if (!eventType.isEnabled()) {
                ...
                switch (eventType.getTitle()) {
                    case "&b&lBrackets":
                        if (player.hasPermission("liquidPractice.host.brackets")) {
                        ...
                        break;
                    case "&b&lSumo":
                        if (player.hasPermission("liquidPractice.host.sumo")) {
                        ...
                        break;
                    case "&b&lLMS":
                        if (player.hasPermission("liquidPractice.host.lms")) {
                        ...
                        break;
                    case "&b&lParkour":
                        if (player.hasPermission("liquidPractice.host.parkour")) {
                        ...
                        break;
                    case "&b&lSpleef":
                        if (player.hasPermission("liquidPractice.host.spleef")) {
                        ...
                        break;
                    case "&b&lWizard":
                        if (player.hasPermission("liquidPractice.host.wizard")) {
