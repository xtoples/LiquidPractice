package dev.liquidnetwork.liquidpractice.util.external.menu;

import dev.liquidnetwork.liquidpractice.LiquidPractice;
import dev.liquidnetwork.liquidpractice.util.bootstrap.BootstrappedListener;
...
public class MenuListener extends BootstrappedListener {
    ...
    public MenuListener(LiquidPractice LiquidPractice) {
        ...
        if (openMenu != null) {
            ...
            if (openMenu.getButtons().containsKey(event.getSlot())) {
                ...
                if (event.isCancelled()) {
                    Bukkit.getScheduler().runTaskLater(LiquidPractice, player::updateInventory, 1L);
                }
            } else {
                if (event.getCurrentItem() != null) {
                    event.setCancelled(true);
