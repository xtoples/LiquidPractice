...
import dev.liquidnetwork.liquidpractice.event.types.brackets.task.BracketsRoundStartTask;
...
import dev.liquidnetwork.liquidpractice.event.types.brackets.task.BracketsRoundEndTask;
...
public class Brackets {
	...
	public List<String> getLore() {
		...
		Brackets brackets = LiquidPractice.getInstance().getBracketsManager().getActiveBrackets();
	...
	public void end() {
		LiquidPractice.getInstance().getBracketsManager().setActiveBrackets(null);
		LiquidPractice.getInstance().getBracketsManager().setCooldown(new Cooldown(60_000L * 10));
	...
	public void onJoin(Player player) {
		LiquidPractice.getInstance().getKnockbackManager().getKnockbackType().applyKnockback(player, LiquidPractice.getInstance().getBracketsManager().getBracketsKnockbackProfile());
	}
	...
	public void onRound() {
		...
		playerA.teleport(LiquidPractice.getInstance().getBracketsManager().getBracketsSpawn1());
		...
		playerB.teleport(LiquidPractice.getInstance().getBracketsManager().getBracketsSpawn2());
