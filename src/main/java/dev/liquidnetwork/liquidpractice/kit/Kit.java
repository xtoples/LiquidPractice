...
import dev.liquidnetwork.liquidpractice.kiteditor.KitEditRules;
...
public class Kit {
    ...
    public void delete() {
        ...
        LiquidPractice.getInstance().getKitsConfig().getConfiguration().set("kits." + getName(), null);
        try {
            LiquidPractice.getInstance().getKitsConfig().getConfiguration().save(LiquidPractice.getInstance().getKitsConfig().getFile());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void preload() {
        FileConfiguration config = LiquidPractice.getInstance().getKitsConfig().getConfiguration();
    ...
    public void save() {
        ...
        BasicConfigurationFile configFile = LiquidPractice.getInstance().getKitsConfig();
