        ...
        switch (layout) {
            case LOBBY: {
                if (profile.getParty() == null) {
                    final boolean activeEvent = (LiquidPractice.getInstance().getSumoManager().getActiveSumo() != null && LiquidPractice.getInstance().getSumoManager().getActiveSumo().isWaiting()) || (LiquidPractice.getInstance().getBracketsManager().getActiveBrackets() != null && LiquidPractice.getInstance().getBracketsManager().getActiveBrackets().isWaiting()) || (LiquidPractice.getInstance().getLMSManager().getActiveLMS() != null && LiquidPractice.getInstance().getLMSManager().getActiveLMS().isWaiting()) || (LiquidPractice.getInstance().getParkourManager().getActiveParkour() != null && LiquidPractice.getInstance().getParkourManager().getActiveParkour().isWaiting()) || (LiquidPractice.getInstance().getSpleefManager().getActiveSpleef() != null && LiquidPractice.getInstance().getSpleefManager().getActiveSpleef().isWaiting());
