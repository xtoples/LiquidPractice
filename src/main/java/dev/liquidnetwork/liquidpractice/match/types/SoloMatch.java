...
public class SoloMatch extends Match {
    ...
    public void setupPlayer(Player player) {
        ...
        Bukkit.getScheduler().runTaskLaterAsynchronously(LiquidPractice.getInstance(), () -> NameTags.color(player, this.getOpponentPlayer(player), org.bukkit.ChatColor.RED, this.getKit().getGameRules().isBuild() || this.getKit().getGameRules().isShowHealth()), 60L);
    }
    ...
    public void onStart() {
        if (getKit().getGameRules().isTimed()) {
            ...
            }.runTaskTimer(LiquidPractice.getInstance(), 20L, 20L);
        }
    }
    ...
    public boolean onEnd() {
        ...
        }.runTaskLaterAsynchronously(LiquidPractice.getInstance(), (getKit().getGameRules().isWaterkill() || getKit().getGameRules().isLavakill() || getKit().getGameRules().isParkour()) ? 0L : 70L);
