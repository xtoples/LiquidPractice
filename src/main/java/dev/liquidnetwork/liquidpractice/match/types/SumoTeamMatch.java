...
public class SumoTeamMatch extends Match {
    ...
    public boolean onEnd() {
        ...
        }.runTaskLater(LiquidPractice.getInstance(), (getKit().getGameRules().isWaterkill() || getKit().getGameRules().isSumo() || getKit().getGameRules().isLavakill() || getKit().getGameRules().isParkour()) ? 0L : 40L);
